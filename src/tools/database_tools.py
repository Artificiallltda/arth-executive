...
def audit_supabase_security():
    ...
    results = run_rls_audit(settings.SUPABASE_DATABASE_URL)
    summary = results["summary"]
    
    report = f"### Relatório de Auditoria RLS\n"
...
def audit_database_schema():
    ...
    issues = run_schema_audit(settings.SUPABASE_DATABASE_URL)
